...
import { BarChart3, Bell, CalendarDays, ClipboardCheck, ClipboardList, FileText, Inbox, ListChecks, Mail, MessageSquareText, Mic, QrCode } from 'lucide-react'
...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      { to: '/cau-hoi/moi', label: 'Gửi câu hỏi', icon: MessageSquareText },
      { to: '/cau-hoi-cua-toi', label: 'Câu hỏi của tôi', icon: ClipboardList },
      { to: '/dieu-phoi', label: 'Hàng đợi điều phối', icon: Inbox },
      { to: '/cau-hoi', label: 'Câu hỏi của đơn vị', icon: ClipboardList },
      { to: '/viec-cua-toi', label: 'Việc của tôi', icon: ListChecks },
      { to: '/duyet-tra-loi', label: 'Duyệt trả lời', icon: ClipboardCheck },
    ],
  },
  {
    code: 'E2',
    ...
    items: [
      ...
      { to: '/thong-tin-nguon', label: 'Thông tin nhận được', icon: Mail },
      { to: '/hieu-qua-khai-thac', label: 'Hiệu quả khai thác', icon: BarChart3 },
    ],
  },
  {
    code: 'E5',
...
/** Mục luôn hiển thị. */
export const COMMON_ITEMS: NavItem[] = [{ to: '/thong-bao', label: 'Thông báo', icon: Bell }]
